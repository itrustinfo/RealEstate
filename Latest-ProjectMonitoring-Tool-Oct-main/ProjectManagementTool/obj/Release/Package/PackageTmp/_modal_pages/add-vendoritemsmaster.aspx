        ...
        <div class="container-fluid" style="max-height: 80vh; overflow-y: auto; margin-top: 15px;">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="lblCss" for="txtCGST">CGST (in %)</label>
                        &nbsp;<span style="color: red; font-size: 1rem;">*</span>
                        <asp:TextBox ID="txtCGST" CssClass="form-control" TextMode="SingleLine" runat="server" ClientIDMode="Static" required="true" placeholder="Enter CGST in %"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="lblCss" for="txtCGST">SGST (in %)</label>
                        &nbsp;<span style="color: red; font-size: 1rem;">*</span>
                        <asp:TextBox ID="txtSGST" CssClass="form-control" TextMode="SingleLine" runat="server" ClientIDMode="Static" required="true" placeholder="Enter SGST in %"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="lblCss" for="txtCGST">GST (in %)</label>
                        &nbsp;<span style="color: red; font-size: 1rem;">*</span>
                        <asp:TextBox ID="txtGST" CssClass="form-control" TextMode="SingleLine" runat="server" ClientIDMode="Static" required="true" placeholder="Enter GST in %"></asp:TextBox>
                    </div>
                    <%--<div class="form-group">
