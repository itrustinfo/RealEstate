                        ...
                        <div class="table-responsive" id="divMain" runat="server">
                            ...
                            <asp:GridView ID="grdMeasurementbook" runat="server" CssClass="table table-bordered" EmptyDataText="No Data" AutoGenerateColumns="False" Width="100%" OnRowDataBound="grdMeasurementbook_RowDataBound" OnRowEditing="grdMeasurementbook_RowEditing" OnRowCancelingEdit="grdMeasurementbook_RowCancelingEdit" OnRowUpdating="grdMeasurementbook_RowUpdating">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="UnitforProgress">
                                       <ItemTemplate>
                                            <asp:Label ID="UnitforProgress" runat="server" Text='<%# Bind("UnitforProgress") %>'></asp:Label>
                                        </ItemTemplate>                                       
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Quantity">
                                       <ItemTemplate>
                                            <asp:Label ID="lblContractor_Quantity" runat="server" Text='<%# Bind("Quantity") %>'></asp:Label>
                                        </ItemTemplate> 
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtContractor_Quantity" runat="server" Text='<%# Bind("Quantity") %>' Enabled="false"></asp:TextBox>
                                        </EditItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Approver1 Quantity">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApprover1_Quantity" runat="server" Text='<%# Bind("Approver1_Quantity") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtApprover1_Quantity" runat="server" Text='<%# Bind("Approver1_Quantity") %>' Enabled="false"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <FooterStyle HorizontalAlign="Left" />
                                    ...
                                    <asp:TemplateField HeaderText="Approver2 Quantity">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApprover2_Quantity" runat="server" Text='<%# Bind("Approver2_Quantity") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtApprover2_Quantity" runat="server" Text='<%# Bind("Approver2_Quantity") %>' Enabled="false"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <FooterStyle HorizontalAlign="Left" />
                                    ...
                                    <asp:TemplateField HeaderText="Approver3 Quantity">
                                        <ItemTemplate>
                                            <asp:Label ID="lblApprover3_Quantity" runat="server" Text='<%# Bind("Approver3_Quantity") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtApprover3_Quantity" runat="server" Text='<%# Bind("Approver3_Quantity") %>' Enabled="false"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <FooterStyle HorizontalAlign="Left" />
                                    ...
                                    <asp:TemplateField HeaderText="CreatedDate" >
                                       <ItemTemplate>
                                            <asp:Label ID="CreatedDate" runat="server" Text='<%# Eval("CreatedDate", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                        </ItemTemplate>
                                   ...
                                   <%-- <asp:BoundField DataField="Achieved_Date" HeaderText="Achieved Date" DataFormatString="{0:dd/MM/yyyy}">
                                    ...
                                    <asp:TemplateField HeaderText="Achieved_Date" >
                                       <ItemTemplate>
                                            <asp:Label ID="Achieved_Date" runat="server" Text='<%# Eval("Achieved_Date", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button ID="btnupdate" runat="server" Text="Edit" CssClass="btn btn-primary" CommandName="edit" CommandArgument="<%#((GridViewRow) Container).RowIndex%>" CausesValidation="false" />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn btn-success" CommandName="Update" />
                                            <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-danger" CommandName="Cancel" />
                                        </EditItemTemplate>
                                    </asp:TemplateField>
