<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.report_stock_issue._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="default_master_body" runat="server">
    <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 col-lg-4 form-group">Stock Issue Report</div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <h6 class="text-muted">
                                     ...
                                     <div style="float:left;width:25%;text-align:right">
                                                   <div style="float:left;width:45%;text-align:left;font:bold" class="form-control-plaintext"><b>From Issue Date&nbsp;:&nbsp;</b></div>
                                               ...
                                               <div style="float:left;width:25%;text-align:right;display:block">
                                                   <div style="float:left;width:45%;text-align:left;font:bold" class="form-control-plaintext"><b>To Issue Date&nbsp;:&nbsp;</b></div>
                                                   <div style="float:left;width:55%;text-align:right">
                                    ...
                                    <div style="overflow: scroll;" id="DivMainContentNew">
                                        <asp:GridView ID="grdDataList" EmptyDataText="No Data Found." runat="server" Width="100%" AutoGenerateColumns="false" CellPadding="6" CellSpacing="16" HeaderStyle-BackColor="#666666" HeaderStyle-ForeColor="White" AlternatingRowStyle-BackColor="#F5F5F5"
                                            ...
                                            <HeaderStyle HorizontalAlign="Left" />
                                                ...
                                                <asp:BoundField DataField="Equipment_Vehicle" HeaderText="Equipment/Vehicle">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="IRRNO" HeaderText="IRR NO">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="IRRDate" HeaderText="IRR Date">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
