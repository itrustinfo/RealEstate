<%@ Page Title="" Language="C#" MasterPageFile="~/_master_pages/default.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ProjectManagementTool._content_pages.invoice_incoming._default" %>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="text-muted">
                                                ...
                                                <div>
                                                        ...
                                                        <a id="AddRAbill" runat="server" href="/_modal_pages/add-rabill-rabillitem-invoice.aspx" class="showModalAddRABill"><asp:Button ID="btnAddRABill" runat="server" Text="+ Add PO" CssClass="btn btn-primary"></asp:Button></a>
                                                    </div>
                                                    </div>
                                                </div>
                                            <div class="table-responsive">
                                       ...
                                       Width="100%">
                                        <Columns>
                                            <asp:TemplateField HeaderText="PO No.">
                                             ...
                                             <asp:BoundField DataField="RABill_Amount" HeaderText="Item No">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                             <asp:BoundField DataField="RABill_Amount" HeaderText="GRN no">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                             <asp:TemplateField>
                                                  <HeaderTemplate>
