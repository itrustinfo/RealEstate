...
namespace ProjectManagementTool._content_pages.vendors
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        protected void DDlProject_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DDlProject.SelectedValue != "")
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    HLAdd.Visible = true;
                    BindVendors();
                    HLAdd.HRef = "/_modal_pages/add-vendorsmaster.aspx?ProjectUID=" + DDlProject.SelectedValue + "&WorkPackageUID=" + DDLWorkPackage.SelectedValue;
        ...
        {
            //WorkPackageUID
            grdVendors.DataSource = getdt.getVendorMaster(new Guid(DDLWorkPackage.SelectedValue));
            grdVendors.DataBind();
        }
        ...
        protected void grdVendors_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                int serialNo = (grdVendors.PageIndex * grdVendors.PageSize) + e.Row.RowIndex + 1;
