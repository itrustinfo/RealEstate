...
namespace ProjectManagementTool._content_pages.engineering_status_update_fasttrack
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        private void BindTaskUpdates()
        {
            ...
            DataSet dsBoq = getdata.GetInspection_Type(ViewState["SelectedTaskUID"].ToString());
            ...
            if (dsTask.Tables[0].Rows.Count > 0)
            {
                ...
                else if (dsTask.Tables[0].Rows[0]["GroupBOQItems"].ToString() == "2")
                {
                    ...
                    DailyUpdate.Visible = true;
                    //
                    GrdMeasurmentUpdate.Columns[1].Visible = false;
                   // GrdMeasurmentUpdate.Columns[2].Visible = false;
                    // Check if the DataSet is not null and has at least one table and one row
                    if (dsBoq != null && dsBoq.Tables.Count > 0 && dsBoq.Tables[0].Rows.Count > 0)
                    {
                        // Retrieve the value from the first row and first column
                        string inspectionType = dsBoq.Tables[0].Rows[0][0].ToString();
                        ViewState["inspectionType"] = inspectionType;
                        ViewState["BOQDetailsUID"] = dsTask.Tables[0].Rows[0]["BOQDetailsUID"].ToString();
                        // Compare the retrieved value
                        if (inspectionType == "Laying & Jointing")
                        {
                            // Do this Task
                            GrdMeasurmentUpdate.Columns[7].Visible = true;
                            GrdMeasurmentUpdate.Columns[8].Visible = true;
                            GrdMeasurmentUpdate.Columns[9].Visible = true;
                            GrdMeasurmentUpdate.Columns[10].Visible = true;
                            GrdMeasurmentUpdate.Columns[11].Visible = true;

                            GrdMeasurmentUpdate.Columns[7].HeaderText = "Dia of Pipe";
                            GrdMeasurmentUpdate.Columns[8].HeaderText = "Chainage Number";
                            GrdMeasurmentUpdate.Columns[9].HeaderText = "Chainage Description";
                            GrdMeasurmentUpdate.Columns[10].HeaderText = "Starting Point";
                            GrdMeasurmentUpdate.Columns[11].HeaderText = "Length";

                        }
                        else if(inspectionType == "Supply")
                        {
                            // Do this Task
                            GrdMeasurmentUpdate.Columns[7].Visible = true;
                            GrdMeasurmentUpdate.Columns[8].Visible = true;
                            ...
                            GrdMeasurmentUpdate.Columns[7].HeaderText = "Dia of Pipe";
                            GrdMeasurmentUpdate.Columns[8].HeaderText = "Pipe Number";
                            GrdMeasurmentUpdate.Columns[9].HeaderText = "Supplier Invoice Number";

                        }
                        else if (inspectionType == "Epoxy" || inspectionType == "Guniting")
                        {
                            // Do this Task
                            GrdMeasurmentUpdate.Columns[7].Visible = true;
                            GrdMeasurmentUpdate.Columns[8].Visible = true;
                            ...
                            GrdMeasurmentUpdate.Columns[7].HeaderText = "Dia of Pipe";
                            GrdMeasurmentUpdate.Columns[8].HeaderText = "Pipe Number";
                            GrdMeasurmentUpdate.Columns[9].HeaderText = "Quantity in Rmt";

                        }
                        else if (inspectionType == "EarthWork/Excavation")
                        {
                            // Do this Task
                            GrdMeasurmentUpdate.Columns[7].Visible = true;
                            GrdMeasurmentUpdate.Columns[8].Visible = true;
                            ...
                            GrdMeasurmentUpdate.Columns[7].HeaderText = "Dia of Pipe";
                            GrdMeasurmentUpdate.Columns[8].HeaderText = "Number";
                            GrdMeasurmentUpdate.Columns[9].HeaderText = "Length";
                            GrdMeasurmentUpdate.Columns[10].HeaderText = "Width";
                            GrdMeasurmentUpdate.Columns[11].HeaderText = "Depth";

                        }
                        else if (inspectionType == "Barricading" || inspectionType == "Dewatering the Sewerage")
                        {
                            // Do this Task
                            GrdMeasurmentUpdate.Columns[7].Visible = true;
                            GrdMeasurmentUpdate.Columns[8].Visible = true;
                        ...
                        else if (inspectionType == "Shoring and Strutting")
                        {
                            // Do this Task
                            GrdMeasurmentUpdate.Columns[7].Visible = true;
                            GrdMeasurmentUpdate.Columns[8].Visible = true;
                            ...
                            GrdMeasurmentUpdate.Columns[8].HeaderText = "Number";
                            GrdMeasurmentUpdate.Columns[9].HeaderText = "Length";
                            GrdMeasurmentUpdate.Columns[10].HeaderText = "Depth";
                        ...
                        else
                        {
                            ...
                            GrdMeasurmentUpdate.Columns[7].Visible = false;
                            GrdMeasurmentUpdate.Columns[8].Visible = false;
                            GrdMeasurmentUpdate.Columns[9].Visible = false;
                            GrdMeasurmentUpdate.Columns[10].Visible = false;

                        }
                    }
                    else
                    {
                        // Handle the case when the DataSet is null or empty
        ...
        protected void btnScheduleUpdate_Click(object sender, EventArgs e)
        {
            if (DDLYear.SelectedValue != "" && DDLMonth.SelectedValue != "")
            {
                try
                {
                    ...
                    {
                        //
                        if ((float.Parse(txtAchievedCurrent.Text) + float.Parse(LblContractorCumulative.Text) > Targetvalue))
                        {
                    ...
                    else
                    {
                        ...
                        //chnaged to only store measuremt values in rable and not in tasks schedule for approval process
                        ...
                        int result = measureupdate.InsertIntoMeasurementBook_FirstEntry(MeasurementUID, new Guid(TaskUID), sUnit, txtAchievedCurrent.Text, "", new Guid(Session["UserUID"].ToString()), txtMeasurementRemarks.Text,CDate1);
                        if (result == -1)
                        {
                            result = measureupdate.InsertMeasurementHistory(Guid.NewGuid(), MeasurementUID, Convert.ToDecimal(txtAchievedCurrent.Text), new Guid(Session["UserUID"].ToString()), Session["MeasurementUser"].ToString());
        ...
        private void ActivityTargetBind()
        {
            if (DDLMonth.SelectedValue != "" && DDLYear.SelectedValue != "")
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //
                    LblContractorCumulative.Text = measureupdate.GetContractorMeasurementData(new Guid(ViewState["SelectedTaskUID"].ToString()), Convert.ToInt32(DDLMonth.SelectedValue), Convert.ToInt32(DDLYear.SelectedValue)).ToString("0.###");
                }
                else
                {
        ...
        protected void BtnMeasurementUpdate_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow row in GrdMeasurmentUpdate.Rows)
            {
                ...
                try
                {
                    ...
                    if (txtTodayQuantity.Text != "" && txtDate.Text != "")
                    {
                        ...
                        else
                        {
                            ...
                            if (TaskUID != string.Empty)
                            {
                                ...
                                //validations for inspection type paramters
                                if (ViewState["inspectionType"] != null)
                                {
                                    TextBox txtdiaofpipe = (TextBox)row.FindControl("TextBoxFixedColumn1");
                                    if (ViewState["inspectionType"].ToString() == "Laying & Jointing")
                                    {
                                        TextBox chainagenumbertxt = (TextBox)row.FindControl("TextBoxFixedColumn2");
                                        TextBox chainagedesctxt = (TextBox)row.FindControl("TextBoxFixedColumn3");
                                        TextBox txtstartingpoint = (TextBox)row.FindControl("TextBoxFixedColumn4");
                                        TextBox txtlength = (TextBox)row.FindControl("TextBoxFixedColumn5");

                                        if (chainagenumbertxt.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Chainage Number.');</script>");
                                            return;

                                        }
                                        else if (chainagedesctxt.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Chainage Description.');</script>");
                                            return;

                                        }
                                        else if (txtstartingpoint.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Starting Point.');</script>");
                                            return;

                                        }
                                        else if (txtlength.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Length.');</script>");
                                            return;
                                    ...
                                    else if (ViewState["inspectionType"].ToString() == "Guniting" || ViewState["inspectionType"].ToString() == "Epoxy")
                                    {
                                        string DiaofPipe_in_mm = getdata.GetBOQDiaofPipe_by_BOQDetailsUID(new Guid(ViewState["BOQDetailsUID"].ToString()));
                                        if (DiaofPipe_in_mm == "Error1:" || DiaofPipe_in_mm == "")
                                        {
                                            DiaofPipe_in_mm = "0";
                                        }

                                        TextBox pipenumbertxt = (TextBox)row.FindControl("TextBoxFixedColumn2");


                                        TextBox txtQtyinRMT = (TextBox)row.FindControl("TextBoxFixedColumn3");
                                        if (pipenumbertxt.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Pipe Number.');</script>");
                                            return;

                                        }
                                        else if (txtQtyinRMT.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Quantity in RMT.');</script>");
                                            return;
                                    ...
                                    else if (ViewState["inspectionType"].ToString() == "EarthWork/Excavation")
                                    {
                                        TextBox txtnumber = (TextBox)row.FindControl("TextBoxFixedColumn2");


                                        TextBox txtMLenght = (TextBox)row.FindControl("TextBoxFixedColumn3");

                                        TextBox txtWidth = (TextBox)row.FindControl("TextBoxFixedColumn4");

                                        TextBox txtDepth = (TextBox)row.FindControl("TextBoxFixedColumn5");
                                        if (txtnumber.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Pipe Number.');</script>");
                                            return;
                                        ...
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Width.');</script>");
                                            return;

                                        }
                                        else if (txtDepth.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Depth.');</script>");
                                            return;
                                        ...
                                        //txtTodayQuantity.Text = Math.Round(Qty, 2).ToString();
                                    }
                                    else if (ViewState["inspectionType"].ToString() == "Barricading")
                                    {
                                        TextBox txtnumber = (TextBox)row.FindControl("TextBoxFixedColumn2");
                                        //number = txtnumber.Text;
                                        TextBox txtMLenght = (TextBox)row.FindControl("TextBoxFixedColumn3");
                                        //MLength = txtMLenght.Text;
                                        ...
                                        if (txtnumber.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Pipe Number.');</script>");
                                            return;
                                    ...
                                    else if (ViewState["inspectionType"].ToString() == "DeWatering the Sewage")
                                    {
                                        TextBox txtnumber = (TextBox)row.FindControl("TextBoxFixedColumn2");
                                        //number = txtnumber.Text;
                                        TextBox txtMLenght = (TextBox)row.FindControl("TextBoxFixedColumn3");
                                    ...
                                    else if (ViewState["inspectionType"].ToString() == "Shoring and Strutting")
                                    {
                                        TextBox txtnumber = (TextBox)row.FindControl("TextBoxFixedColumn2");
                                        //number = txtnumber.Text;
                                        TextBox txtMLenght = (TextBox)row.FindControl("TextBoxFixedColumn3");
                                        //MLength = txtMLenght.Text;
                                        TextBox txtDepth = (TextBox)row.FindControl("TextBoxFixedColumn4");
                                        //Depth = txtDepth.Text;
                                    ...
                                    else if (ViewState["inspectionType"].ToString() == "Supply")
                                    {
                                        TextBox pipenumbertxt = (TextBox)row.FindControl("TextBoxFixedColumn2");
                                        //pipenumber = pipenumbertxt.Text;

                                        TextBox Invoicenumbertxt = (TextBox)row.FindControl("TextBoxFixedColumn3");
                                        //Invoicenumber = Invoicenumbertxt.Text;
                                        if (pipenumbertxt.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Pipe Number.');</script>");
                                            return;
                                        ...
                                        else if (Invoicenumbertxt.Text == "")
                                        {
                                            Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Please Enter Invoice Number.');</script>");
                                            return;
                                ...
                                if (rs > 0)
                                {
                                    //adding JIR insertion from this page itself
                                    Guid inspectionUid =Guid.NewGuid();
                                    ...
                                    string chainagenumber = string.Empty;
                                    string chainagedesc = string.Empty;
                                    string pipenumber = string.Empty;
                                    string number = string.Empty;
                                    string MLength = string.Empty;
                                    ...
                                    if (ViewState["inspectionType"] != null)
                                    {
                                        ...
                                        {
                                            TextBox chainagenumbertxt = (TextBox)row.FindControl("TextBoxFixedColumn2");
                                            chainagenumber = chainagenumbertxt.Text;

                                            TextBox chainagedesctxt = (TextBox)row.FindControl("TextBoxFixedColumn3");
                                            chainagedesc = chainagedesctxt.Text;
                                        ...
                                        else if (ViewState["inspectionType"].ToString() == "Guniting" || ViewState["inspectionType"].ToString() == "Epoxy")
                                        {
                                            ...
                                            Deductions = float.Parse(txtTodayQuantity.Text) * 0.3;
                                        ...
                                        //insertion to JIR
                                        int cnt = getdata.InsertjointInspection(inspectionUid, new Guid(ViewState["BOQDetailsUID"].ToString()), txtdiaofpipe.Text, sUnit, Invoicenumber, CDate1.ToString(), txtTodayQuantity.Text, ViewState["inspectionType"].ToString(), chainagenumber, chainagedesc, StartingPoint, Length, Qty_in_RMT, Qty_for_Unit, Deductions, txtRemarks.Text, new Guid(ddlProject.SelectedValue), pipenumber, number, MLength, Width, Depth, new Guid(ddlworkpackage.SelectedValue));
                                    ...
                                    Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('Data updated successfully.');</script>");
                                    //
                                    TextBox txtb1 = (TextBox)row.FindControl("TextBoxFixedColumn1");
                                    TextBox txtb2 = (TextBox)row.FindControl("TextBoxFixedColumn2");
                                    TextBox txtb3 = (TextBox)row.FindControl("TextBoxFixedColumn3");
                                    TextBox txtb4 = (TextBox)row.FindControl("TextBoxFixedColumn4");
                                    TextBox txtb5 = (TextBox)row.FindControl("TextBoxFixedColumn5");
                                    txtb1.Text = "";
                                    txtb2.Text = "";
                                    txtb3.Text = "";
                                    txtb4.Text = "";
                    ...
                    {
                        Page.ClientScript.RegisterStartupScript(Page.GetType(), "CLOSE", "<script language='javascript'>alert('please enter quantity.');</script>");
                        return;
                    }
                }
                catch (Exception ex)
        ...
        protected void RDBStatusUpdateView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if(RDBStatusUpdateView.SelectedValue == "Resource Deployment")
            {
                DivEngineering.Visible = false;
                DivResourceDeployment.Visible = true;
                Update1.Visible = false;
            ...
            {
                UpdatePanelItem.Visible = true;
                DivEngineering.Visible = false;
                DivResourceDeployment.Visible = false;
                Update1.Visible = false;
                //
                LoadDropdownsForItemsRD();
            }
        }
        ...
        private void LoadDropdownsForItemsRD()
        {
            DDLVendor.Items.Add(new ListItem { Text = "Vendor-1", Value = "Vendor-1" });
            DDLVendor.Items.Insert(0, "--Select--");

            DDLPO.Items.Add(new ListItem { Text = "N-0001", Value = "N-0001" });
            DDLPO.Items.Insert(0, "--Select--");

            DDLItems.Items.Add(new ListItem { Text = "Item-001", Value = "Item-001" });
            DDLItems.Items.Insert(0, "--Select--");
        }

        protected void btnSubmitItem_Click(object sender, EventArgs e)
        {
            DivItemUpdate.Visible = true;
        }
    }
}