        ...
        function DateText() {
            $(function () {
                $("input[id$='dtprojectDate']").datepicker({
                 ...
                 $("input[id$='dtItemDate']").datepicker({
                    changeMonth: true,
                    changeYear: true,
                    dateFormat: 'dd/mm/yy'
                });
...
<asp:Content ID="Content2" ContentPlaceHolderID="default_master_body" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <asp:RadioButtonList ID="RDBStatusUpdateView" runat="server" class="card-title text-muted text-uppercase font-weight-bold" AutoPostBack="true" Width="50%" RepeatDirection="Horizontal" OnSelectedIndexChanged="RDBStatusUpdateView_SelectedIndexChanged">
                                    ...
                                    <asp:ListItem Value="Items">&nbsp;Items Update</asp:ListItem>
                                </asp:RadioButtonList>
                            </div>
                            <div class="col-lg-1">
                            </div>
    ...
    <div style="padding-left: 15px">
        <asp:UpdatePanel ID="UpdatePanelItem" runat="server" Visible="false">
            <ContentTemplate>
                <div class="row">
                    <div class="col-md-12 col-lg-4 form-group" id="Div2" runat="server">
                        <label class="sr-only" for="DDLMainTask">Vendor</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Vendor</span>
                            </div>
                            <asp:DropDownList ID="DDLVendor" runat="server" CssClass="form-control" AutoPostBack="true"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-4 form-group" id="Div3" runat="server" visible="true">
                        <label class="sr-only" for="DDLSubTask">Purchase Order</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Purchase Order</span>
                            </div>
                            <asp:DropDownList ID="DDLPO" runat="server" CssClass="form-control" AutoPostBack="true"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-4 form-group" id="Div4" runat="server" visible="true">
                        <label class="sr-only" for="DDLSubTask1">Items</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Items</span>
                            </div>
                            <asp:DropDownList ID="DDLItems" runat="server" CssClass="form-control" AutoPostBack="true"></asp:DropDownList>
                        </div>
                    </div>
                
                </div>
                <div class="row">
                    <div class="col-md-12 col-lg-4 form-group" id="div11" runat="server">

                        <asp:Button ID="btnSubmitItem" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btnSubmitItem_Click" />
                        &nbsp;<asp:Button ID="btnClearItem" runat="server" Text="Clear" CssClass="btn btn-primary" />
                        <br />
            ...
            <Triggers>
                <asp:PostBackTrigger ControlID="btnSubmitItem" />
            </Triggers>
        </asp:UpdatePanel>
    </div>
    <div class="container-fluid" id="DivItemUpdate" runat="server" visible="false">
         <table class="table table-bordered" id="Table1" runat="server" visible="true">
                                            <tr>
                                                <td><strong>Unit for Progress</strong></td>
                                                <td><strong>Cumulative Quantity</strong></td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label2" runat="server">Numbers</asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label3" runat="server">-</asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="dtItemDate" BorderStyle="None" BorderColor="White" Width="105" class="datepick" runat="server" placeholder="dd/mm/yyyy" autocomplete="off"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtItemquantity" runat="server" TextMode="Number" Enabled="true" CssClass="form-control" Width="120px"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtItemRemarks" runat="server"  CssClass="form-control" Width="280px" TextMode="MultiLine"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
        <asp:Button ID="btnupdateItem" runat="server" Text="Update" CssClass="btn btn-primary" />
        </div>
    <div style="padding-left: 15px">
                                ...
                                <div class="table-responsive">
                                    <div id="divStatus" runat="server" visible="true">
                                        ...
                                        <div class="card-title">
                                            <div class="d-flex justify-content-between" id="divNonBOQMeasurment" runat="server">
                                                ...
                                                <div>
                                                    <a id="TaskScheduleHistory" runat="server" href="/_modal_pages/task-schedulehistory.aspx" class="showTaskMeasurementModal">
                                                        <asp:Button ID="btnTaskScheduleHistory" runat="server" Text="View History" CausesValidation="false" CssClass="btn btn-primary" align="end"></asp:Button></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-bordered" id="ActivitySchedule" runat="server">
                                            ...
                                            <tr>
                                                ...
                                                <td><strong>Approved (Cumulative)</strong></td>
                                                <td><strong>Contractor (Cumulative)</strong></td>
                                                <td><strong>Achieved (Current)</strong></td>
                                                <td><strong>Remarks</strong></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                    <asp:Label ID="LblContractorCumulative" runat="server" Text="-" Width="110px" CssClass="form-control" autocomplete="off"></asp:Label>
                                                </td>
                                                <td>
                                        ...
                                        <table class="table table-bordered" id="MeasurementUpdate" runat="server" visible="false">
                                            <tr>
                                                <td><strong>Unit for Progress</strong></td>
                                                <td><strong>Last&nbsp; Quantity</strong></td>
                                                <td><strong>Date</strong></td>
                                    ...
                                    <div id="DailyUpdate" runat="server" visible="false">
                                        ...
                                        <div class="text-right">
                                            <a id="TaskScheduleHistory1" runat="server" href="/_modal_pages/task-schedulehistory.aspx" class="showTaskMeasurementModal">
                                                <asp:Button ID="btnmeasurement" runat="server" Text="View History" CausesValidation="false" CssClass="btn btn-primary" align="end"></asp:Button></a>
                                            <br />
                                            <br />
                                        </div>
                                        <asp:GridView ID="GrdMeasurmentUpdate" runat="server" DataKeyNames="TaskUID" CssClass="table table-bordered" AutoGenerateColumns="False" AllowPaging="false" OnRowDataBound="GrdMeasurmentUpdate_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="FixedColumn1" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="TextBoxFixedColumn1" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="FixedColumn2" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="TextBoxFixedColumn2" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="FixedColumn3" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="TextBoxFixedColumn3" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="FixedColumn4" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="TextBoxFixedColumn4" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="FixedColumn5" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="TextBoxFixedColumn5" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            ...
                            <div>
                                ...
                                <table class="table table-borderless">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DDLResourceMonth" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DDLResourceMonth_SelectedIndexChanged">
