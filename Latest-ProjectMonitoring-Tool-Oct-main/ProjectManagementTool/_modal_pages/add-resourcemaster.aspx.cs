...
namespace ProjectManagementTool._modal_pages
{
    public partial class add_resourcemaster : System.Web.UI.Page
    {
        ...
        {
            DDLResourceType.DataTextField = "CategoryName";
            DDLResourceType.DataValueField = "ItemCategoryUID";
            //DDLResourceType.DataSource = getdata.getResourceTypeMaster_List();
            DDLResourceType.DataSource = getdt.getItemCategory_List();
        ...
        protected void DDLResourceType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DDLResourceType.SelectedValue != "Select") {
                ...
                ds = getdt.getItemsByCategory(new Guid(DDLResourceType.SelectedValue));
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    DDLResourceName.DataTextField = "GenericName";
                    DDLResourceName.DataValueField = "ItemID";
                ...
                {
                    DDLResourceName.Items.Clear();
                    DDLResourceName.Items.Add(new ListItem("No Resource Available, Please choose another Type", ""));
                }
            }
            else
            {
