...
namespace ProjectManagementTool
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        MeasurementUpdate update = new MeasurementUpdate();
            ...
            try
            {
               ...
               // {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        //added on 06/03/2024 for measurement approver type
                        Session["MeasurementUser"] = update.GetMeasurementApprovalDetails(new Guid(Session["UserUID"].ToString()));
